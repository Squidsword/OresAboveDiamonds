...
public class ItemList 
{
	...
	public static Item netherite_opal_sword;
	public static Item netherite_opal_pickaxe;
	public static Item netherite_opal_shovel;
	public static Item netherite_opal_axe;
	public static Item netherite_opal_hoe;
	...
	public static Item netherite_opal_helmet;
	public static Item netherite_opal_chestplate;
	public static Item netherite_opal_leggings;
	public static Item netherite_opal_boots;
