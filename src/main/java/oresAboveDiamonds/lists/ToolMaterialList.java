...
public enum ToolMaterialList implements IItemTier 
{
	...
	netherite_opal(OADConfig.netherite_opal_attack_damage.get(), OADConfig.netherite_opal_efficiency.get(), OADConfig.netherite_opal_durability.get(), 5, OADConfig.netherite_opal_enchantability.get(), ItemList.black_opal);
