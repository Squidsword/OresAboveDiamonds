		...
		if(action.equalsIgnoreCase("write")) {
			...
			if (option.equalsIgnoreCase("amethyst_enchantability")) {
				if(isParsableInt(value)) {
					...
					source.sendFeedback(new TranslationTextComponent("Successfully changed Amethyst Chance to §d" + OADConfig.amethyst_enchantability.get().toString()), false);
				} else {
					source.sendErrorMessage(new TranslationTextComponent("Invalid input. New value must be a int."));
				}
			}
			if (option.equalsIgnoreCase("black_opal_enchantability")) {
				if(isParsableInt(value)) {
					...
					source.sendFeedback(new TranslationTextComponent("Successfully changed Amethyst Chance to §5" + OADConfig.black_opal_enchantability.get().toString()), false);
				} else {
					source.sendErrorMessage(new TranslationTextComponent("Invalid input. New value must be a int."));
				}
			}
			...
			if (option.equalsIgnoreCase("nether_chance_multiplier")) {
				if(isParsableDouble(value)) {
					...
					source.sendFeedback(new TranslationTextComponent("Successfully changed Amethyst Chance to " + OADConfig.nether_chance_multiplier.get().toString()), false);
				} else {
					source.sendErrorMessage(new TranslationTextComponent("Invalid input. New value must be a double."));
				}
			}
			if (option.equalsIgnoreCase("end_chance_multiplier")) {
				if(isParsableDouble(value)) {
					...
					source.sendFeedback(new TranslationTextComponent("Successfully changed Amethyst Chance to " + OADConfig.end_chance_multiplier.get().toString()), false);
				} else {
					source.sendErrorMessage(new TranslationTextComponent("Invalid input. New value must be a double."));
				}
			}
			...
			if (option.equalsIgnoreCase("old_combat_mechanics")) {
				if(Boolean.parseBoolean(value)) {
					...
					source.sendFeedback(new TranslationTextComponent("For this change to take effect, " + OADConfig.old_combat_mechanics.get().toString()), false);
				} else {
					source.sendErrorMessage(new TranslationTextComponent("Invalid input. New value must be a boolean."));
				}
			}
