...
public class AmethystToolAxe extends ItemAxe implements IHasModel {

	public AmethystToolAxe(String name, ToolMaterial material) {
		
		super(material, OADConfig.ao_amethyst_attack_damage + 5, -3f);
